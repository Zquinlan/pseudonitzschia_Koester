...
write.csv(quant_binary_org,"./Analyzed/quant_binary_org_0.05.csv")
...
write_csv(feature_info_test, "Analyzed/Ttest_elements_orgX.csv")
...
write_csv(feature_info_test_dom, "Analyzed/Ttest_elements_domX.csv")
